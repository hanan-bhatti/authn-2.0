...
func (urc *UserRoleCreate) SetAssignedByUserID(s string) *UserRoleCreate {
	urc.mutation.SetAssignedByUserID(s)
	return urc
}

// SetNillableAssignedByUserID sets the "assigned_by_user_id" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableAssignedByUserID(s *string) *UserRoleCreate {
	if s != nil {
		urc.SetAssignedByUserID(*s)
	}
	return urc
}

// SetUpdatedByUserID sets the "updated_by_user_id" field.
func (urc *UserRoleCreate) SetUpdatedByUserID(s string) *UserRoleCreate {
	urc.mutation.SetUpdatedByUserID(s)
	return urc
}

// SetNillableUpdatedByUserID sets the "updated_by_user_id" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableUpdatedByUserID(s *string) *UserRoleCreate {
	if s != nil {
		urc.SetUpdatedByUserID(*s)
	}
	return urc
}
