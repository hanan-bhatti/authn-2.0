...
func (oiq *OrgInvitationQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (oiq *OrgInvitationQuery) FirstIDX(ctx context.Context) string {
...
func (oiq *OrgInvitationQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (oiq *OrgInvitationQuery) OnlyIDX(ctx context.Context) string {
...
func (oiq *OrgInvitationQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (oiq *OrgInvitationQuery) IDsX(ctx context.Context) []string {
	ids, err := oiq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(orginvitation.FieldOrganizationID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OrgInvitation.Query().
//		Select(orginvitation.FieldOrganizationID).
//		Scan(ctx, &v)
...
func (oiq *OrgInvitationQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*OrgInvitation, init func(*OrgInvitation), assign func(*OrgInvitation, *Organization)) error {
	...
	nodeids := make(map[string][]*OrgInvitation)
	for i := range nodes {
...
func (oiq *OrgInvitationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(orginvitation.Table, orginvitation.Columns, sqlgraph.NewFieldSpec(orginvitation.FieldID, field.TypeString))
	_spec.From = oiq.sql
