...
3. **Permission Catalog & API Spec Updates**: The new permission string MUST be added to the RBAC permission catalog and documented in [`docs/03-API-SPECIFICATION.md`](file:///home/hanan-bhatti/authn/docs/03-API-SPECIFICATION.md).
